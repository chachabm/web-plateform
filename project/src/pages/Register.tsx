      ...
      <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Félicitations {formData.name} ! Votre compte a été créé avec succès. Vous allez être redirigé vers votre tableau de bord dans quelques instants.
          </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          {/* Bannière de Notification Email */}
          {showEmailNotification && (
            <div className="mb-6 bg-red-50 border border-red-200 rounded-lg p-4">
              <div className="flex items-start space-x-3">
                <CheckCircle className="h-5 w-5 text-red-600 mt-0.5" />
                <div>
                  <h4 className="text-sm font-medium text-red-900">Email de Bienvenue Envoyé !</h4>
                  <p className="text-sm text-red-700 mt-1">
                    Nous envoyons un email de bienvenue à <strong>{formData.email}</strong> avec des informations importantes pour commencer.
                  </p>
                  <p className="text-xs text-red-600 mt-2">
                    Veuillez vérifier votre boîte de réception (et dossier spam) pour le message de bienvenue.
                  </p>
                </div>
              </div>
            </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                📧 Nous vous enverrons un email de bienvenue avec des informations importantes sur le compte
              </p>
            </div>
            ...
            >
              {isLoading ? (
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <span>Création du Compte & Envoi d'Email...</span>
                </div>
              ) : (
                'Créer un Compte'
              )}
